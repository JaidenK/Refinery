...
--          {cost, full name, buy brick, machine model, production increase}
   ...
   CrudeImport = {100, "Crude Import", workspace.BuyCrudeImport, workspace.CrudePipe, 10, "You've cut a deal with a nearby oil drilling company, and they're willing to send you a small amount of crude oil to get your refinery started. All you have to do is pay to set up the pipes and the crude will start flowing.", {1581752829, 200, 200}},
   ...
   Walls = {100, "Walls", workspace.BuyWalls, workspace.Walls, nil, "Walls surround your refinery and prevent people from accidentally wandering onto your property. This is the first tier of security for your refinery."},
